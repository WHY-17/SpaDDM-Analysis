...
data_ari = {
    ...
    "GraphST": [0.4470, 0.2334, 0.0860, 0.1678, 0.5174, 0.4165, 0.4459, 0.2690]
}
...
data_nmi = {
    ...
    "GraphST": [0.5141, 0.4307, 0.2375, 0.3744, 0.6252, 0.5826, 0.5348, 0.4564]
}
...
data_ami = {
    ...
    "GraphST": [0.5084, 0.4170, 0.2247, 0.3637, 0.6196, 0.5724, 0.5262, 0.4435]
}
...
data_hom = {
    ...
    "GraphST": [0.5640, 0.4864, 0.2748, 0.4287, 0.6454, 0.6096, 0.5643, 0.5057]
}
...
algorithms = ["MultiVI", "totalVI", "scMM", "scAI", "GraphST", "Seurat", "SpatialGlue", "SpaDDM"]
...
# 移除原图例
ax.legend_.remove()
plt.savefig('C:/Users/haiyu/Desktop/SpaDDM revised figures/box_plot.pdf', dpi=300)
...
plt.savefig('C:/Users/haiyu/Desktop/SpaDDM revised figures/box_plot_legend.pdf', dpi=300)