...
data_file = 'Data/Dataset2_Mouse_Spleen2/'
...
sc.pl.embedding(adata, basis='spatial', color=['GraphST'], show=False, size=8, ax=axs[4],
              legend_fontsize=0, legend_loc='on data')
axs[4].invert_yaxis()
...
sc.pl.embedding(adata, basis='spatial', color=['Seurat'], show=False, size=8, ax=axs[5],
              legend_fontsize=0, legend_loc='on data')
axs[5].invert_yaxis()
...
sc.pl.embedding(adata, basis='spatial', color=['SpatialGlue'], show=False, size=8, ax=axs[6],
              legend_fontsize=0, legend_loc='on data')
axs[6].invert_yaxis()
...
sc.pl.embedding(adata, basis='spatial', color=['SpatialDDM'], show=False, size=8, ax=axs[7],
              legend_fontsize=0, legend_loc='on data')
axs[7].invert_yaxis()
# axs[6].spines['right'].set_visible(False) # 去掉边框
# axs[6].spines['top'].set_visible(False)   # 去掉边框
...
plt.savefig('C:/Users/haiyu/Desktop/SpaDDM revised figures/mouse_spleen2_embedding-8.pdf', dpi=300)
...
plt.show()
plt.savefig('C:/Users/haiyu/Desktop/SpaDDM revised figures/mouse_spleen_embedding_legend.pdf', dpi=300)
...
plt.savefig('C:/Users/haiyu/Desktop/SpaDDM revised figures/mouse_spleen2_UMAP-8.pdf', dpi=300)