...
# 重组数据结构
section_order = ['H3K4me3', 'H3K27ac', 'H3K27me3']
algorithms = ["MultiVI", "totalVI", "scMM", "Seurat", "GraphST", "SpatialGlue", "SpaDDM"]
...
plt.savefig('C:/Users/haiyu/Desktop/SpaDDM revised figures/mouse brain box plot-2.5.pdf', dpi=300)
...
# 合并数据
data_all = pd.concat([data2, data3, data4], ignore_index=True)
...
ax.legend_.remove()
plt.tight_layout(pad=0.5)
plt.savefig('C:/Users/haiyu/Desktop/SpaDDM revised figures/mouse brain trustworthiness plot-2.5.pdf', dpi=300)
...
# 合并数据
moran_all = pd.concat([moran2, moran3, moran4], ignore_index=True)
...
ax.legend_.remove()
plt.tight_layout(pad=0.5)
plt.savefig('C:/Users/haiyu/Desktop/SpaDDM revised figures/mouse brain morans plot-2.5.pdf', dpi=300)




fig_legend = plt.figure(figsize=(8, 2))  # 宽一点，矮一点
...
plt.savefig('C:/Users/haiyu/Desktop/SpaDDM revised figures/mouse brain legend plot.pdf', dpi=300)