...
data_file = 'Data/Dataset13_Simulation1/'
...
adata.uns['Ground Truth'] = plot_color


fig, axs = plt.subplots(1, 7, figsize=(17.5, 2.5),constrained_layout=True)
sc.pl.embedding(adata, basis='spatial', color=['Ground Truth'], show=False, size=70, ax=axs[0],
...
sc.pl.embedding(adata, basis='spatial', color=['MultiVI'], show=False, size=70, ax=axs[1],
              legend_fontsize=0, legend_loc='on data')
# axs[1].invert_yaxis()
...
sc.pl.embedding(adata, basis='spatial', color=['totalVI'], show=False, size=70, ax=axs[2],
              legend_fontsize=0, legend_loc='on data')
# axs[2].invert_yaxis()
...
sc.pl.embedding(adata, basis='spatial', color=['scMM'], show=False, size=70, ax=axs[3],
              legend_fontsize=0, legend_loc='on data')
# axs[3].invert_yaxis()
...
sc.pl.embedding(adata, basis='spatial', color=['Seurat'], show=False, size=70, ax=axs[4],
              legend_fontsize=0, legend_loc='on data')
# axs[4].invert_yaxis()
...
sc.pl.embedding(adata, basis='spatial', color=['SpatialGlue'], show=False, size=70, ax=axs[5],
              legend_fontsize=0, legend_loc='on data')
# axs[5].invert_yaxis()
...
sc.pl.embedding(adata, basis='spatial', color=['SpatialDDM'], show=False, size=70, ax=axs[6],
              legend_fontsize=0, legend_loc='on data')
# axs[5].invert_yaxis()
...
plt.savefig('Results/Simulation/simulation1_embedding.pdf', dpi=300)
...
sc.pl.umap(adata, color='Ground Truth', ax=axs[0], show=False,
           size=40, legend_loc='on data', legend_fontsize=0)
axs[0].spines['right'].set_visible(False) # 去掉边框
axs[0].spines['top'].set_visible(False)   # 去掉边框
axs[0].spines['left'].set_visible(False) # 去掉边框
axs[0].spines['bottom'].set_visible(False)   # 去掉边框
...
axs[6].get_xaxis().set_visible(False)
axs[6].set_title('', fontsize=15)
plt.savefig('Results/Simulation/simulation1_UMAP.pdf', dpi=300)
...
plt.show()
plt.savefig('Results/Simulation/plot_legend.pdf', dpi=300)