...
adata_ddm = sc.read_h5ad(data_file+'spatialDDM_results_noscale.h5ad')
...
for emb_name in emb_names:
    adata = mclust_R(adata, num_cluster=14, used_obsm=emb_name)
...
fig, axs = plt.subplots(1, 8, figsize=(8,1),constrained_layout=True)
...
sc.pl.embedding(adata, basis='spatial', color=['Seurat'], show=False, size=10, ax=axs[5],
              legend_fontsize=0, legend_loc='on data')
axs[5].invert_yaxis()
...
sc.pl.embedding(adata, basis='spatial', color=['SpatialGlue'], show=False, size=10, ax=axs[6],
              legend_fontsize=0, legend_loc='on data')
axs[6].invert_yaxis()
...
sc.pl.embedding(adata, basis='spatial', color=['SpatialDDM'], show=False, size=10, ax=axs[7],
              legend_fontsize=0, legend_loc='on data')
axs[7].invert_yaxis()
...
plt.savefig('Results/MISAR/E18_5-S1_embedding-8.pdf', dpi=300)
...
sc.pl.umap(Umap_Seurat, color='Seurat', ax=axs[5], show=False,
           size=10, legend_loc='on data', legend_fontsize=0)
# axs[5].spines['right'].set_visible(False) # 去掉边框
# axs[5].spines['top'].set_visible(False)   # 去掉边框
# axs[5].spines['left'].set_visible(False) # 去掉边框
...
sc.pl.umap(Umap_SpatialGlue, color='SpatialGlue', ax=axs[6], show=False,
           size=10, legend_loc='on data', legend_fontsize=0)
# axs[6].spines['right'].set_visible(False) # 去掉边框
# axs[6].spines['top'].set_visible(False)   # 去掉边框
# axs[6].spines['left'].set_visible(False) # 去掉边框
...
sc.pl.umap(Umap_SpatialDDM, color='SpatialDDM', ax=axs[7], show=False,
           size=10, legend_loc='on data', legend_fontsize=0)
# axs[7].spines['right'].set_visible(False) # 去掉边框
# axs[7].spines['top'].set_visible(False)   # 去掉边框
# axs[7].spines['left'].set_visible(False) # 去掉边框
...
plt.savefig('Results/MISAR/E18_5-s1_umap-8.pdf', dpi=300)
