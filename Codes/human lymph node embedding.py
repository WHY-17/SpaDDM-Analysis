...
Clustering_evaluation(adata, Ground_Truth='Ground Truth', pred_label='totalVI')
Clustering_evaluation(adata, Ground_Truth='Ground Truth', pred_label='MultiVI')
Clustering_evaluation(adata, Ground_Truth='Ground Truth', pred_label='scAI')
Clustering_evaluation(adata, Ground_Truth='Ground Truth', pred_label='Seurat')
Clustering_evaluation(adata, Ground_Truth='Ground Truth', pred_label='SpatialGlue')
Clustering_evaluation(adata, Ground_Truth='Ground Truth', pred_label='SpatialDDM')
Clustering_evaluation(adata, Ground_Truth='Ground Truth', pred_label='scMM')
Clustering_evaluation(adata, Ground_Truth='Ground Truth', pred_label='GraphST')



plot_color = ['#A2D4F1', '#EBA2A3', '#E8D5E8', '#CEE6C1', '#F3D78A', '#81ABCB']
...
plt.savefig('C:/Users/haiyu/Desktop/SpaDDM revised figures/D1_LN_embedding-8.pdf', dpi=300)
...
Umap_GraphST = sc.AnnData(adata_graphst.obsm['emb_pca'])
...
plt.savefig('C:/Users/haiyu/Desktop/SpaDDM revised figures/D1_LN_Umap-8.pdf', dpi=300)
...
plt.show()
plt.savefig('C:/Users/haiyu/Desktop/SpaDDM revised figures/A1_LN_legend.pdf', dpi=300)
