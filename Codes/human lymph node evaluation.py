...
# 你想评估的各方法列名
methods = ['totalVI', 'MultiVI', 'Seurat', 'GraphST', 'SpatialDDM', 'SpatialGlue', 'StabMap']
# 用于存储结果
results = []
...
algorithms = ["MultiVI", "StabMap", "GraphST", "Seurat", "totalVI", "SpatialGlue", "SpaDDM"]
...
# 移除原图例
ax.legend_.remove()
plt.savefig('C:/Users/haiyu/Desktop/SpaDDM revised figures/human lymph node A1 plot-4.pdf', dpi=300)
...
# 移除原图例
ax.legend_.remove()
plt.savefig('C:/Users/haiyu/Desktop/SpaDDM revised figures/human lymph node D1 plot-4.pdf', dpi=300)
...
plt.savefig('C:/Users/haiyu/Desktop/SpaDDM revised figures/human lymph node legend plot.pdf', dpi=300)
