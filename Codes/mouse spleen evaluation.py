...
df1 = pd.read_csv('Data/Dataset1_Mouse_Spleen1/Trustworthiness_box_data.csv', index_col=0)
df2 = pd.read_csv('Data/Dataset2_Mouse_Spleen2/Trustworthiness_box_data.csv', index_col=0)
...
algorithms = ["MultiVI", "totalVI", "scMM", "StabMap", "GraphST", "Seurat", "SpatialGlue", "SpaDDM"]
...
plt.savefig('C:/Users/haiyu/Desktop/SpaDDM revised figures/mouse spleen box plot-2.8.pdf', dpi=300)


data1 = pd.read_csv('Data/Dataset1_Mouse_Spleen1/Trustworthiness_data.csv', index_col=0)
data2 = pd.read_csv('Data/Dataset2_Mouse_Spleen2/Trustworthiness_data.csv', index_col=0)
...
ax.legend_.remove()
plt.tight_layout(pad=1.0)
plt.savefig('C:/Users/haiyu/Desktop/SpaDDM revised figures/mouse spleen trustworthiness plot.pdf', dpi=300)



moran1 = pd.read_csv('Data/Dataset1_Mouse_Spleen1/morans_data.csv', index_col=0)
moran2 = pd.read_csv('Data/Dataset2_Mouse_Spleen2/morans_data.csv', index_col=0)
...
# 合并数据
moran_all = pd.concat([moran1, moran2], ignore_index=True)
...
ax.legend_.remove()
plt.tight_layout(pad=1.0)
plt.savefig('C:/Users/haiyu/Desktop/SpaDDM revised figures/mouse spleen morans plot.pdf', dpi=300)
...
plt.savefig('Results/mouse spleen legend plot.pdf', dpi=300)