...
plt.savefig('Results/mouse spleen box plot.pdf', dpi=300)
...
ax.legend_.remove()
plt.tight_layout(pad=1.0)
plt.savefig('Results/mouse spleen trustworthiness plot.pdf', dpi=300)
...
ax.legend_.remove()
plt.tight_layout(pad=1.0)
plt.savefig('Results/mouse spleen morans plot.pdf', dpi=300)
