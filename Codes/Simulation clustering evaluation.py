...
# 需要计算的聚类标签列
methods = ['totalVI', 'MultiVI', 'scMM', 'Seurat', "GraphST", 'SpatialGlue', 'SpatialDDM']
# 指标函数映射
metrics = {
...
ax.legend_.remove()
plt.savefig('C:/Users/haiyu/Desktop/SpaDDM revised figures/Simulation clustering evaluation.pdf', dpi=300)
...
plt.savefig('C:/Users/haiyu/Desktop/SpaDDM revised figures/Simulation clustering evaluation legend.pdf', dpi=300)
