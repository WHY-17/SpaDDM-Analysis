...
cols = ["MultiVI", "totalVI", "GraphST", "Seurat", "SpatialGlue", "SpatialDDM"]
...
sns.boxplot(data=df, x="method", y="r", palette=algorithm_colors, width=0.6, linewidth=1.0, fliersize=0)
sns.stripplot(data=df, x="method", y="r", color="black", alpha=0.6, jitter=0.25, size=1.5)
plt.xlabel("")
plt.ylabel("Cluster correlation", fontsize=7)
plt.xticks(fontsize=7, rotation=25)  # X轴刻度字体
...
plt.show()
plt.savefig('C:/Users/haiyu/Desktop/SpaDDM revised figures/Trustworthiness_box_plot.pdf', dpi=300)
...
# 美化
plt.ylabel("Global correlation (r)", fontsize=7)
plt.xlabel("")
...
plt.tight_layout(pad=0.5)
plt.show()
plt.savefig('C:/Users/haiyu/Desktop/SpaDDM revised figures/Trustworthiness_plot.pdf', dpi=300)
...
plt.tight_layout(pad=0.5)
plt.show()
plt.savefig('C:/Users/haiyu/Desktop/SpaDDM revised figures/Moran_plot.pdf', dpi=300)
